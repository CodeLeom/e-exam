...
if ($_POST) {
    ...
    if ($next == $total) {
        header("Location: c_question.php?n=0&q=$examNum[0]&xsssdsdxxssdhfdghsjhfjdhdhsjdhdhfjfhsbsdhddjshs=" . $exam_id);
    }

    if ($number + 1 == $total) {
        header("Location: c_question.php?n=0&q=$examNum[0]&xsssdsdxxssdhfdghsjhfjdhdhsjdhdhfjfhsbsdhddjshs=" . $exam_id);
    } else {
        header("Location: c_question.php?n=" . $next . "&q=$examNum[$next]&xsssdsdxxssdhfdghsjhfjdhdhsjdhdhfjfhsbsdhddjshs=" . $exam_id);
    }
}