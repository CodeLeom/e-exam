...
function update_access_setting(){
    ...
    if(isset($_POST['save_access_settings'])){
        ...
        $cvcs = sanitize($_POST['cvcs']);
        $cdcs = sanitize($_POST['cdcs']);
        $nlp = sanitize($_POST['nlp']);
        $c_exam = sanitize($_POST['c_exam']);
        $exam_type = sanitize($_POST['exam_type']);

        updateSetting($cdms,10);
        updateSetting($cvms,9);
        updateSetting($cdps,11);
        updateSetting($cvcs,18);
        updateSetting($cdcs,19);
        updateSetting($cvps,8);
        updateSetting($c_exam,17);
        updateSetting($nlp,20);
