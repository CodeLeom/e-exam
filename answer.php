                        ...
                        <div class="row">
                            <div class="panel panel-default">
                                <div class="panel-heading text-capitalize">
                                    <h3><?php echo "$full_name $year $sub $type"; ?> Exam Slip <span class="pull-right">Score : <?php echo $score ?> / <?php echo $total ?></span> </h3>
                                </div>
            ...
            $('#answers').DataTable( {
                ...
                buttons: [
...

                    {
                        ...
                        title: '<?php echo $sub; ?>',
                        exportOptions: {
                             // indexes of the columns that should be printed,
                        }                      // Exclude indexes that you don't want to print.
                    },
                    {
                        extend: 'print',
                        title: 'Subject : <?php echo $sub; ?> / Score : <?php echo $score ?> / <?php echo $total ?>',
