                ...
                <div class="">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-heading">
                            ...
                            <h3>List of Available <?php echo getField('name','custom_exams',$selected_course) ?> Exams <span class="pull-right"><button class="btn btn-primary btn-sm" data-title="Edit" data-toggle="modal" data-target="#addCourse" >ADD Exam</button></span> </h3>
...
if(isset($_GET['delete'])){
    ...
    header("Location: c_exams.php?c=$selected_course");
}
